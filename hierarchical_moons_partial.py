...
params_noise = jax.vmap(model.init, (0, None))(key_tasks, batch)
params_mu=model.init(key_params_mu,batch)
...
samples,loss,accuracy=sgd(key_state_init,log_post,
                            ...
                            params_pooled,train_data,
                            test_data,batch_size)

results=accuracy_cnn(samples[-1],Xs_test,Ys_test)
